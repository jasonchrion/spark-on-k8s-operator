...
func (in *Kerberos) DeepCopyInto(out *Kerberos) {
	*out = *in
	...
	if in.KerberosPrincipal != nil {
		in, out := &in.KerberosPrincipal, &out.KerberosPrincipal
		*out = new(string)
		**out = **in
	}
	...
	if in.KeytabName != nil {
		in, out := &in.KeytabName, &out.KeytabName
		*out = new(string)
		**out = **in
	}
	if in.Krb5ConfigMap != nil {
		in, out := &in.Krb5ConfigMap, &out.Krb5ConfigMap
		*out = new(string)
		**out = **in
	}
	return
...
func (in *SparkApplicationSpec) DeepCopyInto(out *SparkApplicationSpec) {
	*out = *in
	...
	in.Kerberos.DeepCopyInto(&out.Kerberos)
	if in.Volumes != nil {
